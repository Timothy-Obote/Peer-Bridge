...
interface SessionWithMeta extends TutorSession {
  rating?: number;
  feedback?: string;
  scheduled_at?: string;
}
...
const SAMPLE_UPCOMING: TutorSession[] = [
  {
    id: 101,
    tutee_id: 201,
    tutee_name: "Alice Wanjiru",
    courses: [
...
const MOCK_SCHEDULED: Record<number, string> = {
  101: "2026-04-06T15:00:00Z",
  102: "2026-04-12T14:00:00Z",
};
...
const MOCK_FEEDBACK: Record<number, string> = {
  1: "Great session! Very helpful.",
  2: "Learned a lot in a short time.",
  3: "Excellent explanation of concepts.",
  4: "Could be more detailed next time.",
  5: "Clear and concise teaching.",
};
...
const TutorSessions = () => {
  ...
  const [apiData, setApiData] = useState<TutorSessionsResponse | null>(null);
    ...
    const fetchData = async () => {
      ...
      try {
        ...
        const res = await fetch(
          `${import.meta.env.VITE_API_URL}/api/tutor-sessions/${user.id}`,
        ...
        <div className="sidebar-top">
          ...
          <div className="sidebar-middle">
            ...
            <nav className="nav-links">
              ...
              <a
                onClick={() => handleNavigation("/tutor/sessions")}
      ...
      <main className="my-sessions-main">
        ...
        <section className="greeting-section">
          <h1 className="greeting-title">
            Hey {tutorName} <span aria-hidden="true">👋</span>, good to see you.
          </h1>
        ...
        <section>
          <div className="section-header">
            ...
            <p className="section-subtitle">
              You have tutored {summaryWithUpcoming.total} students in total.
            </p>
          </div>
              ...
              {upcomingSessions.map((session) => (
                <div key={session.id} className="session-card upcoming-session-card">
                  <div className="session-card-header">
                    <h3 className="student-name">{session.tutee_name}</h3>
        ...
        <section>
          ...
          <div className="insights-panel">
            ...
            <div className="insights-grid">
              ...
              <div className="insight-stat">
                <span className="insight-label">Students Helped</span>
                <span className="insight-value">{insights.studentsHelped}</span>
              </div>
            </div>
          </div>
        </section>
        ...
        <footer className="utility-footer">
          ...
          <span className="utility-divider" />
          <a href="#tips" className="utility-link">Tutor Tips</a>
        </footer>
      </main>
    </div>
  );
